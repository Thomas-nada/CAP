...
These are the most frequent issues editors encounter during initial review. Avoiding them will speed up your proposal's progression through the process.
...
## 2. Bundling unrelated changes into one CAP

A single CAP should address one coherent change or a closely related set of changes. Mixing unrelated amendments makes the proposal harder to review, harder to deliberate, and harder to ratify — a community may support some changes but not others.

**Fix:** If your proposal touches multiple unrelated provisions, split it into separate CAPs.
